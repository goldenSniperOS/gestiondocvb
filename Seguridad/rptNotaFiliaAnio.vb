...
Public Class rptNotaFiliaAnio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Seguridad.rptNotaFiliaAnio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptNotaFiliaAnio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptNotaFiliaAnio = New rptNotaFiliaAnio()
        rpt.Site = Me.Site
        Return rpt
    End Function
